...
namespace MovieWebApp.Migrations
{
    ...
    [Migration("20241130121433_ImagesContry2")]
    partial class ImagesContry2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieApp.DataModels.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d486c03-189e-43a8-979d-d57527258428"),
                        ...
                        new
                        {
                            Id = new Guid("55fb532d-b2d7-4cab-82f5-e229d8387ecb"),
                        ...
                        new
                        {
                            Id = new Guid("00ce29d0-3a90-4ed8-8f2b-ffd327e2ddde"),
                        ...
                        new
                        {
                            Id = new Guid("22b2580f-8712-48ea-b740-7cfd8619b4ac"),
                        ...
                        new
                        {
                            Id = new Guid("2f79bc6f-d4f5-407a-af64-9d3c3198a7fe"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e62ae36a-b15c-4426-8315-8d29809a6149"),
                        ...
                        new
                        {
                            Id = new Guid("3eab56ab-c842-4408-bbf9-b0f8bb300152"),
                        ...
                        new
                        {
                            Id = new Guid("51761664-b840-4e5c-ad9e-254a75db3a39"),
                        ...
                        new
                        {
                            Id = new Guid("f395930a-9258-4f37-a82f-2be137c7d7b0"),
                        ...
                        new
                        {
                            Id = new Guid("27c6da16-3b31-4c65-8c72-0f639c28208d"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("98d368ec-36da-4849-8392-f482324b3de3"),
                        ...
                        new
                        {
                            Id = new Guid("1afbdf01-cfdc-433f-8a68-4f658e9a107c"),
                        ...
                        new
                        {
                            Id = new Guid("6e0d0c45-9307-4226-bf74-c075de31cfa2"),
                        ...
                        new
                        {
                            Id = new Guid("8f119e6d-3645-4f88-9c59-1c166804d113"),
                        ...
                        new
                        {
                            Id = new Guid("48a11011-d7ec-4f8e-96fc-a5ec647599e7"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("01f3004d-9035-400d-ac26-ebd7438d204b"),
                        ...
                        new
                        {
                            Id = new Guid("03907fd1-0789-4a5e-af6d-e5d6fa40b603"),
                        ...
                        new
                        {
                            Id = new Guid("ade4b4db-1e6a-49b7-9196-0c93ca8230d1"),
                        ...
                        new
                        {
                            Id = new Guid("f926ef02-87a1-44db-bb41-c86f69b0e9b7"),
                        ...
                        new
                        {
                            Id = new Guid("c5d920ae-d38a-4287-b469-52ff638ba1a5"),
                        ...
                        new
                        {
                            Id = new Guid("f95d5f8b-cc37-4365-87e7-84aa7df86b34"),
                        ...
                        new
                        {
                            Id = new Guid("f3623b84-a427-4106-95d9-1e2f918de384"),
                        ...
                        new
                        {
                            Id = new Guid("83f9f218-3c44-4bdd-b7e3-85f9cd40434b"),
                        ...
                        new
                        {
                            Id = new Guid("e2aab6ea-3c02-4320-b1b8-734fa3acb8d7"),
                        ...
                        new
                        {
                            Id = new Guid("c205bc2c-651f-4ff3-80ef-6f0bff2fccee"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Quote", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05c13cf4-801d-4fc3-b566-e973ef5195ba"),
                        ...
                        new
                        {
                            Id = new Guid("479c922e-0685-4300-9d7c-20d17843921b"),
                        ...
                        new
                        {
                            Id = new Guid("8600e7af-2384-4ff6-bd32-59aebf5cc4d7"),
                        ...
                        new
                        {
                            Id = new Guid("79c98dfa-3980-4831-8b46-256424b7670d"),
                            CharacterName = "Yoda",
                        ...
                        new
                        {
                            Id = new Guid("356f1347-4881-4865-a351-d22b099a39fe"),
