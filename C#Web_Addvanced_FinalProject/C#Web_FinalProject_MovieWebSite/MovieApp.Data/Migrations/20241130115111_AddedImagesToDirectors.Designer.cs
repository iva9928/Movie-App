...
namespace MovieWebApp.Migrations
{
    ...
    [Migration("20241130115111_AddedImagesToDirectors")]
    partial class AddedImagesToDirectors
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieApp.DataModels.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07239111-e2ec-478f-ba63-1fcca957da2b"),
                        ...
                        new
                        {
                            Id = new Guid("95053b1f-faff-4f6b-a8b3-6dc5b26b347e"),
                        ...
                        new
                        {
                            Id = new Guid("37c6d152-ad8a-4dcc-86aa-825925e1a702"),
                        ...
                        new
                        {
                            Id = new Guid("11f7563b-734c-4745-8b71-7451d5a2bd9d"),
                        ...
                        new
                        {
                            Id = new Guid("b1246227-ad8c-431c-aded-dc0990379d3a"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("155fd42c-fae4-4bc3-9a62-66369d4f5bae"),
                            CountryImageUrl = "",
                        ...
                        new
                        {
                            Id = new Guid("ba07c01f-b9f1-4ddb-b89f-174b4779ae1e"),
                            CountryImageUrl = "",
                        ...
                        new
                        {
                            Id = new Guid("d73a14c7-fb1c-4c44-a69c-f0c915d76117"),
                            CountryImageUrl = "",
                        ...
                        new
                        {
                            Id = new Guid("82b4d9f8-c887-4873-a6a9-42f499f8fdd5"),
                            CountryImageUrl = "",
                        ...
                        new
                        {
                            Id = new Guid("f1fa2627-0c1f-4291-a898-b266953def6f"),
                            CountryImageUrl = "",
            ...
            modelBuilder.Entity("MovieApp.DataModels.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("edf68a19-b4a7-4828-833b-a218bb5994bd"),
                        ...
                        new
                        {
                            Id = new Guid("65b554f9-28b6-4998-881d-810534656ff4"),
                            ...
                            DirectorImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjOgxOMZLxo08pZYDjeOUHbTdcr0effjx5ow&s.jpg",
                        ...
                        new
                        {
                            Id = new Guid("18e94d33-21c8-4260-a08f-ca7a7e747cdf"),
                            ...
                            DirectorImageUrl = "https://static.wikia.nocookie.net/strangerthings8338/images/4/4d/Frank_Darabont.jpeg/revision/latest?cb=20240625153651.jpg",
                        ...
                        new
                        {
                            Id = new Guid("19b5e235-9b4b-4c54-b48f-71643d196ec2"),
                            ...
                            DirectorImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoBQhIob2SDQF5m87_kuuxe5ZpFyXNDp2vwMr_i_wpH4Vz4Nwhc4nVT_tdQ4DWos-CI9s&usqp=CAU.jpg",
                        ...
                        new
                        {
                            Id = new Guid("55a4fbff-63c4-41c0-b267-127626fd6928"),
                            ...
                            DirectorImageUrl = "https://www.beaconsfieldfilmsociety.com/wp-content/uploads/2019/05/download-3.jpg",
            ...
            modelBuilder.Entity("MovieApp.DataModels.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("17e2df89-2b63-4072-8ead-59df0ad72dd4"),
                        ...
                        new
                        {
                            Id = new Guid("2d80d229-6c71-49ae-9552-ce2712b79114"),
                        ...
                        new
                        {
                            Id = new Guid("70be7fb9-dd68-4346-9211-7011271b02d4"),
                        ...
                        new
                        {
                            Id = new Guid("23df9d29-ae0b-43a0-b545-89848d8057cf"),
                        ...
                        new
                        {
                            Id = new Guid("a43d1fbf-f0c1-4a85-b427-fd6445ee99bf"),
                        ...
                        new
                        {
                            Id = new Guid("5910408f-f477-425c-afbd-38d7e803ece3"),
                        ...
                        new
                        {
                            Id = new Guid("0153b94b-fab2-44a5-a02a-ab052b3d68bc"),
                        ...
                        new
                        {
                            Id = new Guid("8a975c16-0641-4ae5-b148-6942c9607c5c"),
                        ...
                        new
                        {
                            Id = new Guid("84751006-d1dc-450a-84d0-fecca5478deb"),
                        ...
                        new
                        {
                            Id = new Guid("0a221134-ab9d-4a67-94a1-aa43280437f2"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Quote", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed5bf64c-eea0-48b2-b329-d89bb30d2662"),
                        ...
                        new
                        {
                            Id = new Guid("4bf9d386-779d-4ec6-be25-a7288f7ad6c6"),
                        ...
                        new
                        {
                            Id = new Guid("c12cb579-8d31-44df-a704-e6e705375414"),
                        ...
                        new
                        {
                            Id = new Guid("ca44351a-8d0c-4bd3-a4eb-2544f9adde01"),
                            CharacterName = "Yoda",
                        ...
                        new
                        {
                            Id = new Guid("1b686d5f-0b77-4a75-885b-2cc6fc063638"),
