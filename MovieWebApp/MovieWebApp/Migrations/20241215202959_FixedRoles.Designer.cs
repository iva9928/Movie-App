...
namespace MovieWebApp.Migrations
{
    ...
    [Migration("20241215202959_FixedRoles")]
            ...
            modelBuilder.Entity("MovieApp.DataModels.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3fa8e7c6-ac10-406c-972b-3b63004dc7be"),
                        ...
                        new
                        {
                            Id = new Guid("3182c2b1-9931-4ab6-9f98-5d3826e2e496"),
                        ...
                        new
                        {
                            Id = new Guid("64b45479-9af6-4a1c-b97d-76c61ad03f97"),
                        ...
                        new
                        {
                            Id = new Guid("35ade5a8-c1cc-4952-a252-8b0410efa01a"),
                        ...
                        new
                        {
                            Id = new Guid("9c820578-2183-4adb-be73-3001fccf848c"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e028d7a4-4fa4-4ee3-b926-046c340563c1"),
                        ...
                        new
                        {
                            Id = new Guid("6abe811d-e3e1-43e5-9b41-7a51105155c3"),
                        ...
                        new
                        {
                            Id = new Guid("a45e32aa-021d-4975-b246-5a039f17fba5"),
                        ...
                        new
                        {
                            Id = new Guid("fa4111b3-bae8-4308-a3a8-19066c57dabc"),
                        ...
                        new
                        {
                            Id = new Guid("8e059903-757a-408c-9a06-9d5421c2050e"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd61f06f-78b6-4dfc-a21a-dc28f615c7dd"),
                        ...
                        new
                        {
                            Id = new Guid("a1242fa5-ddb9-403a-9ffe-25511baed6bf"),
                        ...
                        new
                        {
                            Id = new Guid("2fa6a099-3e13-4ad4-b048-ba19e3c81d04"),
                        ...
                        new
                        {
                            Id = new Guid("9a0bd992-5db6-442f-9058-8f7dc64a3dc8"),
                        ...
                        new
                        {
                            Id = new Guid("f757f4e4-efd9-40dd-9886-b37f59212757"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6a7dc1b3-0f39-41a2-90a5-2b865c0e40e8"),
                        ...
                        new
                        {
                            Id = new Guid("dd1b55b1-639f-4dd9-bd35-6a8c5531daaa"),
                        ...
                        new
                        {
                            Id = new Guid("99fc1ee7-f84b-416c-a40f-bb52d2bc81b7"),
                        ...
                        new
                        {
                            Id = new Guid("8745253a-77f9-4166-bc2b-dd95221114e5"),
                        ...
                        new
                        {
                            Id = new Guid("4562be8b-81be-4b76-baf4-6745b49f6dbf"),
                        ...
                        new
                        {
                            Id = new Guid("5ac27c8b-c0d8-4c7d-af80-3b7ef1091df9"),
                        ...
                        new
                        {
                            Id = new Guid("1f8b2889-271e-4494-aea9-c841f2cd1624"),
                        ...
                        new
                        {
                            Id = new Guid("6a25faff-ab27-434e-839a-3f40e73b7ad4"),
                        ...
                        new
                        {
                            Id = new Guid("a58d3f7f-71b7-4f07-a48e-42a131acb997"),
                        ...
                        new
                        {
                            Id = new Guid("a8f0231a-3f36-4c9f-88bb-4037ec7f1966"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.Quote", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5100babc-77b7-4182-b716-6c84d14c804b"),
                        ...
                        new
                        {
                            Id = new Guid("9bd3fac1-0b29-43bd-898d-46a042e02627"),
                        ...
                        new
                        {
                            Id = new Guid("2c96d396-830e-48da-96fa-32069ff5d17e"),
                        ...
                        new
                        {
                            Id = new Guid("c9aae8f1-ff44-4e2f-aa07-a02d14c1bfe5"),
                        ...
                        new
                        {
                            Id = new Guid("306398f8-f6c0-4d4f-b93e-ad9f64e2fded"),
            ...
            modelBuilder.Entity("MovieApp.DataModels.TVShows", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea7a0c85-7ca0-423f-b0d0-e93ddd23535b"),
                        ...
                        new
                        {
                            Id = new Guid("dae87f75-7c1a-450d-a430-f0566594b460"),
                        ...
                        new
                        {
                            Id = new Guid("2cfab3e0-0b12-4e92-b53e-b6c0605f997d"),
                        ...
                        new
                        {
                            Id = new Guid("766e41bf-316a-4489-a6b5-67cc2a96dc2e"),
                        ...
                        new
                        {
                            Id = new Guid("815d19ee-ccef-4b65-a9bc-deaf45641f6d"),
                        ...
                        new
                        {
                            Id = new Guid("26f4b01e-af42-495d-95d9-5ad9cd7f8467"),
                            Casts = "Wentworth Miller, Dominic Purcell, Sarah Wayne Callies, Paul Adelstein, Rockmond Dunbar",
                            Country = "United States of America",
                            Description = "Due to a political warfare, an innocent man has been sent to death row and his only hope is his own brother, who makes it his obligation to deliberately get himself shipped to the identical prison as a way to break both of them out, from the inside out.",
                            Duration = 45,
                        ...
                        new
                        {
                            Id = new Guid("629d0fac-b84f-4db1-8688-17f2921b4686"),
                            Casts = "Bryan Cranston, Anna Gunn, Aaron Paul, Dean Norris, Betsy Brandt",
                            Country = " United States of America",
                            Description = "When a New Mexico chemistry educator, Walter White, has been diagnosed with Stage III cancer and given a prognosis of two years ago to live. He's filled to secure his family's financial future at any cost since he enters the dangerous environment of crime and drugs.",
                            Duration = 45,
                        ...
                        new
                        {
                            Id = new Guid("c062f23d-d280-454a-90c0-45680d3ddc39"),
                            Casts = "Cillian Murphy, Paul Anderson, Helen McCrory, Sophie Rundle, Joe Cole",
                            Country = "United Kingdom",
                            Description = "A gangster family epic set in England, 1919 Birmingham and predicated on their boss Tommy Shelby, who means to maneuver on earth, along with a gang that sew razor blades from the peaks of their caps.",
                            Duration = 60,
                        ...
                        new
                        {
                            Id = new Guid("f6e72649-0f62-48f1-930a-8eb6fbba6fff"),
                            Casts = "Paul Wesley, Ian Somerhalder, Nina Dobrev, Kat Graham, Candice King",
                            Country = "United States of America",
                            Description = "The story of two brothers obsessed with the same girl, that bears a striking resemblance to the beautiful but ruthless vampire they knew and adored from 1864.",
                            Duration = 45,
                        ...
                        new
                        {
                            Id = new Guid("a0cd9419-2ffd-4231-8c2f-6adc2795d304"),
                            Casts = "Blake Lively, Leighton Meester, Penn Badgley, Chace Crawford, Ed Westwick",
                            Country = "United States of America",
                            Description = "A private group of privileged teens out of the prep school on Manhattan's Upper East Side whose lives revolve round the allknowing albeit ultra-secretive Gossip Girl's site.",
                            Duration = 45,
